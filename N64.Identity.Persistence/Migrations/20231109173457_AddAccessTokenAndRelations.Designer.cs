...
namespace N64.Identity.Persistence.Migrations
{
    ...
    [Migration("20231109173457_AddAccessTokenAndRelations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("N64.Identity.Domain.Entities.AccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("N64.Identity.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 9, 17, 34, 57, 371, DateTimeKind.Utc).AddTicks(5428),
                            IsDisabled = false,
                        ...
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 9, 17, 34, 57, 371, DateTimeKind.Utc).AddTicks(5431),
                            IsDisabled = false,
                            ModifiedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = 0
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 9, 17, 34, 57, 371, DateTimeKind.Utc).AddTicks(5433),
                            IsDisabled = false,
                            ModifiedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = 1
                        });
            ...
            modelBuilder.Entity("N64.Identity.Domain.Entities.AccessToken", b =>
                {
                    b.HasOne("N64.Identity.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("N64.Identity.Domain.Entities.AccessToken", "UserId")
